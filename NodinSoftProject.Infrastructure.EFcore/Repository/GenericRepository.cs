...
namespace NodinSoftProject.Infrastructure.EFcore.Repository
{
    public class GenericRepository<TEntity> : IGenericRepository<TEntity> where TEntity : BaseEntity
    {
        private readonly NodinSoftProjectDBContext _context;
        private readonly DbSet<TEntity> _dbSet;

        public GenericRepository(NodinSoftProjectDBContext context)
        {
            _context = context;
